...
---
Код распространяется [под лицензией MIT](LICENSE.md), шрифты имеют собственные лицензии: [для Graphik](LICENSE-FONT-GRAPHIK.md), [для Spot Mono](LICENSE-FONT-SPOT-MONO.md) — подробнее читайте [в документации](docs/license.md).
